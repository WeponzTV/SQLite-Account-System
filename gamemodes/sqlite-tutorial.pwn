...
stock SaveAccount(playerid)
{
	...
	if(PlayerData[playerid][player_logged] == true)
	{
		...
		"UPDATE `USERS` SET SCORE = '%d', KILLS = '%d', DEATHS = '%d' WHERE `NAME` = '%s' COLLATE NOCASE", GetPlayerScore(playerid), PlayerData[playerid][player_kills], PlayerData[playerid][player_deaths], DB_Escape(GetName(playerid)));
